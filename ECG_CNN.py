...
model_a = Sequential()
model_a.add(Conv1D(input_shape=(len(x_onehot[0]),  len(x_onehot[0][0])), filters=16, kernel_size=4, padding='same'))
model_a.add(BatchNormalization())
model_a.add(LeakyReLU())
model_a.add(Dropout(0.5))

model_a.add(Conv1D(filters=8, kernel_size=4, padding='same'))
model_a.add(BatchNormalization())
model_a.add(LeakyReLU())
model_a.add(Dropout(0.5))
...
#model_a.add(LeakyReLU())
model_b = Sequential()
model_b.add(Conv1D(input_shape=(len(y_onehot[0]),  len(y_onehot[0][0])), filters=16, kernel_size=4, padding='same'))
model_b.add(BatchNormalization())
model_b.add(LeakyReLU())
model_b.add(Dropout(0.5))

model_b.add(Conv1D(filters=8, kernel_size=4, padding='same'))
model_b.add(BatchNormalization())
model_b.add(LeakyReLU())
model_b.add(Dropout(0.5))
